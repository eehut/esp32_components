...
#if CONFIG_BUS_MANAGER_I2C_BUS_MAX_NUM > 0
// I2C总线句柄数组
...
#endif // CONFIG_BUS_MANAGER_I2C_BUS_MAX_NUM > 0


// UART硬件配置数组
#if CONFIG_BUS_MANAGER_UART_MAX_NUM > 0
...
#endif // CONFIG_BUS_MANAGER_UART_MAX_NUM > 0
